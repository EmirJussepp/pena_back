...
fun Application.reportes(
    reportesRepository: ReportesRepository,
    database: Database
) {
    routing {
        // JSON (esto queda igual que antes)
        ...
        // CSV (corregido: transaction + JdbcConnectionImpl)
            ...
            try {
                ...
                val sql = """
                    SELECT p.pago_id, p.fecha_pago, p.monto,
                           ...
                           c.cobradores_id, c.nombre AS cobrador,
                ...
                val csv = org.jetbrains.exposed.sql.transactions.transaction(database) {
                    ...
                    val conn = (exposedConn as JdbcConnectionImpl).connection  // <- FIX
